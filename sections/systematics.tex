...
\hline
Selection requirement & Default cut & Variations\\
\hline
\hline
...
\begin{table}
  ...
  \resizebox{0.75\textwidth}{!}{\begin{tabular}[!b]{|l|c|c|}
  \hline
  Selection requirements & Default cut & Variations\\
  \hline
  \hline
